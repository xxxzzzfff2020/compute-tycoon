...
assert(html.includes('content="20260829-standalone-h5-v2"'), "single-player version marker missing");
...
for (const required of ["resumeFromBackground", "offline.moneyCredited", "stage3.estimatedRemaining", "room.1.autoDesc"]) {
  assert(bundle.includes(required), `latest game update missing: ${required}`);
}
