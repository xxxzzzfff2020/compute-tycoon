...
- `public/assets/visuals/icon-atlases/`, `public/assets/visuals/icons/`, and `public/assets/visuals/server-rack-array-v1.svg` — project-supplied visual assets from the August 28, 2026 formal H5 release. They follow the project-media restrictions below, not the MIT code license.
...
The BGM files, game artwork/icon atlases, and official-site media are not covered by the MIT code license; redistribution outside this repository requires separate permission. See `docs/oss/BGM_GENERATION_RECORD.md` for BGM provenance.

See `docs/oss/THIRD_PARTY_AND_ASSET_LICENSE_AUDIT.md` for the full asset provenance audit.

## Platform integrations

The GitHub single-player edition does not call or load the TapTap runtime. `src/platform/` contains only disabled feature gates and optional browser-local vibration. Older platform audit documents are retained as development history, not a description of active integrations.
